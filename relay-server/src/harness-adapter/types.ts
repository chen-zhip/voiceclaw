// Structured output protocol shared by Harness Integration Contract boundaries and the output router.
//
...
/** Incremental chunks streamed from a Harness Integration Contract boundary. */
